    ...
    _uri = _document.uri // 从资源管理器打开，只有 uri 没有 _document
        ...
        this._panel.webview.onDidReceiveMessage(async (message) => {
            ...
            switch (message.command) {
                ...
                case 'upload': {
                    const imageSaveFolder = (this._config.get('imageSaveFolder') || 'assets')
                        .replace('${projectRoot}', ((_a = vscode.workspace.getWorkspaceFolder(this._uri)) === null || _a === void 0 ? void 0 : _a.uri.fsPath) || '')
